...
import { ListOnboarding } from '../components/ListOnboarding';
  ...
  return (
    <div>
      ...
      </div>
      {
        groupId
          ?
          <ListOnboarding groupId={groupId} token={token} airline={props.airline} role={role} dirRole={dirRole} graphData={graphData} objectId={objectId} />
          :
          <div></div>
      }
